      ...
      <div v-if="visible" class="login-overlay" @click.self="handleClose">
        <div class="login-modal">
          ...
          <div class="modal-header">
            <div class="logo-section">
              <svg class="logo-icon" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M16 2L4 8v8c0 8 5.33 15.47 12 18 6.67-2.53 12-10 12-18V8L16 2z" fill="currentColor" opacity="0.1"/>
                <path d="M16 4L6 9v7c0 6.8 4.27 13.17 10 15.4 5.73-2.23 10-8.6 10-15.4V9L16 4z" stroke="currentColor" stroke-width="1.5" fill="none"/>
                <circle cx="16" cy="14" r="4" stroke="currentColor" stroke-width="1.5"/>
                <path d="M12 22c0-2.2 1.8-4 4-4s4 1.8 4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
              </svg>
              <h1 class="logo-text">TokenDance</h1>
            </div>
            <h2 class="modal-title">登录</h2>
            <p class="modal-subtitle">登录后可使用完整的 AI 智能工作台功能</p>
          </div>
          ...
          <div class="modal-footer">
            <p>
              还没有账号？
              <router-link to="/register" @click="handleClose" class="link">
                立即注册
              </router-link>
            </p>
          </div>
