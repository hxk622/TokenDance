...
<template>
  <div class="browser-operation-log bg-bg-secondary rounded-lg border border-border-default">
    ...
    <div class="max-h-80 overflow-y-auto">
      ...
      >
        ...
        >
          ...
          <div
            class="flex-shrink-0"
            :class="getOperationColor(op.type)"
          >
            <!-- Globe -->
            <svg
              v-if="getOperationIcon(op.type) === 'globe'"
              class="w-4 h-4"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            ...
            <!-- Cursor Click -->
            <svg
              v-else-if="getOperationIcon(op.type) === 'cursor-click'"
              class="w-4 h-4"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            ...
            <!-- Pencil -->
            <svg
              v-else-if="getOperationIcon(op.type) === 'pencil'"
              class="w-4 h-4"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            ...
            <!-- Camera -->
            <svg
              v-else-if="getOperationIcon(op.type) === 'camera'"
              class="w-4 h-4"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            ...
            <!-- Photo -->
            <svg
              v-else-if="getOperationIcon(op.type) === 'photo'"
              class="w-4 h-4"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
    ...
    <div
      v-if="operations.length > 0"
      class="px-4 py-2 border-t border-border-default flex items-center justify-between text-xs text-text-tertiary"
    >
