...
class TestIntegration:
    ...
    def test_full_pipeline(self):
        ...
        bg = bg_gen.generate(BackgroundStyle.DIAGONAL_GRADIENT)
        
        # 2. 生成装饰
        deco_gen = DecorationGenerator(1920, 1080)
        deco1 = deco_gen.generate(DecorationStyle.CORNER_LINES)
        deco2 = deco_gen.generate(DecorationStyle.SPOTLIGHT)
