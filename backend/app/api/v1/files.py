...
class SearchRequest(BaseModel):
    ...
    language: str | None = Field(default=None, description="过滤语言")
...
_file_indexer: FileIndexerService | None = None
_code_analyzer: CodeAnalyzerService | None = None
_vector_indexer: VectorIndexerService | None = None
