...
from app.models.agent_state import AgentState, AgentCheckpoint
...
class AgentStateRepository:
    ...
    async def get_by_session(self, session_id: str) -> Optional[AgentState]:
...
class AgentCheckpointRepository:
    ...
    async def create(
        ...
        working_memory_snapshot: Optional[dict] = None,
