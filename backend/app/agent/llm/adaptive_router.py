...
from .advanced_router import AdvancedRouter, RoutingConstraints, RoutingContext
from .router import TaskType, MODEL_REGISTRY
...
class AdaptiveRouter(AdvancedRouter):
    ...
    def _select_for_exploration(self, task_type: TaskType) -> Optional[str]:
    ...
    def get_ab_test_results(self, name: str) -> Optional[Dict[str, Any]]:
        """获取 A/B 测试结果"""
