...
from ....agent.agents.ppt import PPTOutline, PPTStyle, SlideContent, SlideType
from ....services.ppt_renderer import ExportFormat, MarpTheme, PPTRenderConfig, get_ppt_renderer
...
def get_outline(outline_id: str) -> PPTOutline | None:
    """获取大纲"""
...
- Any structured content"""
    ...
    def _generate_slides(self, content: str, target_count: int) -> list[SlideContent]:
        ...
        max(1, remaining_slots // len(sections)) if sections else 2
