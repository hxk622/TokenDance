...
class PPTOutline:
    ...
    # 元数据
    source_content: Optional[str] = None  # 原始内容（如研究报告）
...
class PPTAgent(BaseAgent):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ppt_state: Optional[PPTState] = None
...
""" + markdown_content
    ...
    def generate_outline_from_content(
        ...
        # 3. 内容页
        slides_per_section = max(1, (target_slides - 4) // len(sections)) if sections else 2
