...
class SmartBrowserService(BrowserAutomationService):
    ...
    def __init__(
        ...
        self._primary: Optional[AgentBrowserService] = None
        self._fallback: Optional[PlaywrightFallbackService] = None
        self._active: Optional[BrowserAutomationService] = None
