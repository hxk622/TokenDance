...
from app.models.agent_config import AgentConfig, LLMProvider, LLMModel
...
class AgentConfigService:
    ...
    async def get_config_for_session(self, session_id: str) -> Optional[AgentConfig]:
    ...
    async def get_available_models(self, provider_name: Optional[str] = None) -> List[LLMModel]:
