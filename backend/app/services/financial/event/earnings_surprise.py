...
class EarningsSurprise:
    ...
    # 股价反应
    price_change_1d: Optional[float] = None  # 发布后1日涨跌幅
    price_change_5d: Optional[float] = None  # 发布后5日涨跌幅
...
# 全局单例
_earnings_surprise_service: Optional[EarningsSurpriseService] = None
