...
from app.schemas.workspace import WorkspaceCreate, WorkspaceUpdate, WorkspaceResponse, WorkspaceDetail, WorkspaceList
...
class WorkspaceService:
    ...
    ) -> Optional[WorkspaceResponse | WorkspaceDetail]:
        """Get workspace by ID."""
    ...
    async def get_workspace_sessions(
        ...
        from app.schemas.session import SessionResponse, SessionList
