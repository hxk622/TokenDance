...
from .models import SlideType, SlideContent, BrandKit, TemplateConfig
...
class TemplateEngine:
    ...
    def get_template(self, slide_type: SlideType) -> Optional[SlideTemplate]:
        """根据幻灯片类型获取模板
    ...
    def get_template_by_name(self, name: str) -> Optional[SlideTemplate]:
        """根据名称获取模板
