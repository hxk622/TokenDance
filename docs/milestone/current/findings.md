...
**时间**: 2026-01-14 (发布于2026-01-12/13)  
**来源**: Web搜索 (2-Action Rule)

**产品定位**:  
通用AI Agent，"Claude Code for the rest of your work"。降低使用门槛，专为非技术用户设计。

**核心功能**:
1. **文件系统访问** - 用户授权特定文件夹，Agent可读写创建文件
2. **自主执行** - 自动制定计划、并行执行、自我检查
3. **沙盒环境** - 容器化虚拟机（Apple Virtualization Framework）
4. **集成能力** - 可与Chrome插件、Gmail连接器等组合

**使用场景**:
- 自动整理下载文件夹
- 从收据截图生成费用表
- 从散乱笔记生成报告初稿
- 度假研究、制作幻灯片、清理邮件、恢复照片等

**产品演进**:
- 由Claude Code衰生 - 用户将开发工具用于非编码任务
- 全功能在**1.5周**内完成（使用Claude Code自身建造）
- 从命令行工具 → 桌面应用 → Cowork通用Agent

**定价与可用性**:
- 研究预览阶段
- 仅Max订阅用户 ($100-200/月)
- 目前Mac OS，计划支持Windows
...
**战略意义**:
- 从开发者工具 → 企业生产力市场
- 直接竞争Microsoft Copilot
- 已在企业市场超越OpenAI

**对TokenDance的启示**:

1. **产品演进路径** - 先做开发者工具，再降低门槛普及
2. **沙盒隔离重要性** - 文件系统访问必须在安全环境中
3. **自主执行是趋势** - "少像对话，多像留言给同事"
4. **透明性至关重要** - 用户需要知道Agent在做什么
5. **AI建造AI** - 用Claude Code建造Cowork，1.5周完成

**差异化机会**:
- **Vibe Workflow理念** - 我们强调情感价值，Cowork偏功能工具
- **三文件工作法** - 我们有独特的Context管理
- **多模态能力** - Deep Research + PPT + Code，Cowork更通用
- **开源生态** - 我们可以构建开放平台
